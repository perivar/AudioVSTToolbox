...
namespace PresetConverter
{
	...
	public class Zebra2Preset : Preset
	{
		...
		private string GeneratePresetLFO(string description, string name,
		                                 int lfoSync,
		                                 int lfoTrig,
		                                 int lfoWave,
		                                 float lfoPhse,
		...
		private string GeneratePresetOscillator(string description, string name,
		                                        int oscillatorWave,
		...
		public override string ToString() {
			...
			buffer.Append(GeneratePresetLFO("Lfo 1", "LFO1",
			                                LFO1_Sync,
			                                LFO1_Trig,
			                                LFO1_Wave,
			                                LFO1_Phse,
			...
			buffer.Append(GeneratePresetLFO("Lfo 2", "LFO2",
			                                LFO2_Sync,
			                                LFO2_Trig,
			                                LFO2_Wave,
			                                LFO2_Phse,
			...
			buffer.Append(GeneratePresetLFO("Lfo 3", "LFO3",
			                                LFO3_Sync,
			                                LFO3_Trig,
			                                LFO3_Wave,
			                                LFO3_Phse,
			...
			buffer.Append(GeneratePresetLFO("Lfo 4", "LFO4",
			                                LFO4_Sync,
			                                LFO4_Trig,
			                                LFO4_Wave,
			                                LFO4_Phse,
			...
			buffer.Append(GeneratePresetOscillator("Oscillator1", "Osc1",
			                                       OSC1_Wave,
			                                       OSC1_Tune,
			                                       OSC1_KeyScl,
			                                       OSC1_TMSrc,
			...
			buffer.Append(GeneratePresetOscillator("Oscillator2", "Osc2",
			                                       OSC2_Wave,
			                                       OSC2_Tune,
			                                       OSC2_KeyScl,
			                                       OSC2_TMSrc,
			...
			buffer.Append(GeneratePresetOscillator("Oscillator3", "Osc3",
			                                       OSC3_Wave,
			                                       OSC3_Tune,
			                                       OSC3_KeyScl,
			                                       OSC3_TMSrc,
			...
			buffer.Append(GeneratePresetOscillator("Oscillator4", "Osc4",
			                                       OSC4_Wave,
			                                       OSC4_Tune,
			                                       OSC4_KeyScl,
			                                       OSC4_TMSrc,
