...
using System.IO;
public static class GlobalMembersCWT
{



	//*********************************************************
	//  finally: the main function (entry point for program)
	//*********************************************************

//C++ TO C# CONVERTER NOTE: __stdcall is not available in C#:
//ORIGINAL LINE: void __stdcall WinMain()
...
//  1997 - 2004
//C++ TO C# CONVERTER TODO TASK: Instead of '#using', in C# add a project reference:
//#using <mscorlib.dll>
//C++ TO C# CONVERTER TODO TASK: Instead of '#using', in C# add a project reference:
//#using <System.dll>
//C++ TO C# CONVERTER TODO TASK: Instead of '#using', in C# add a project reference:
...
public class Wavelet_Dialog : Form
{
	...
	public Wavelet_Dialog()
	{
		...
		Size = System.Drawing.Size(240,240);

		OKButton = new Button();
		OKButton.Text = "OK";
		OKButton.Size = System.Drawing.Size(40,25);
		OKButton.Location = Point(100,160);
		OKButton.Click += new EventHandler(OKButton_Clicked);
		Controls.Add(OKButton);

		Cancel_Button = new Button();
		Cancel_Button.Text = "Cancel";
		Cancel_Button.Size = System.Drawing.Size(60,25);
		Cancel_Button.Location = Point(150,160);
		Cancel_Button.Click += new EventHandler(Cancel_Button_Clicked);
		Controls.Add(Cancel_Button);

		sigmaLabel = new Label();
		sigmaBox = new TextBox();
		sigmaLabel.Location = Point(20,20);
		sigmaLabel.Size = System.Drawing.Size(70,16);
		sigmaLabel.Text = "sigma";
		sigmaLabel.TextAlign = ContentAlignment.MiddleRight;
		sigmaBox.Location = Point(90,20);
		sigmaBox.Size = System.Drawing.Size(60,20);
		...
		lowerfreqLabel.Location = Point(20,50);
		lowerfreqLabel.Size = System.Drawing.Size(70,16);
		lowerfreqLabel.Text = "lower freq";
		lowerfreqLabel.TextAlign = ContentAlignment.MiddleRight;
		lowerfreqBox.Location = Point(90,50);
		lowerfreqBox.Size = System.Drawing.Size(60,20);
		...
		upperfreqLabel.Location = Point(20,80);
		upperfreqLabel.Size = System.Drawing.Size(70,16);
		upperfreqLabel.Text = "upper freq";
		upperfreqLabel.TextAlign = ContentAlignment.MiddleRight;
		upperfreqBox.Location = Point(90,80);
		upperfreqBox.Size = System.Drawing.Size(60,20);
...
//*********************************************************
	...
	public CWTForm()
	{
		...
		Text = "CWT";
		FormBorderStyle = FormBorderStyle.FixedDialog;
		Size = System.Drawing.Size(600, 600);
